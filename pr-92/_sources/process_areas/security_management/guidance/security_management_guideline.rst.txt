...
.. gd_guidl:: Security plan definitions
   ...
   **Overall security management:**
   ...
   So the module security managers shall consult the `REPLACE_doc__platform_security_plan` and
   ...
   enable communication (as defined in `REPLACE_doc__project_mgt_plan`). Another main communication
   ...
   **Tailoring security activities:**
   ...
   `REPLACE_doc__platform_security_plan`.
   ...
   **Planning security activities:**
   ...
   as specified in the `REPLACE_doc__project_mgt_plan`
