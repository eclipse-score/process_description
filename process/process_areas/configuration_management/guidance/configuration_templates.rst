...
Each work product is identified by its "structured text" Id, this includes documents identified as such (by the document header as defined in :need:`gd_temp__documentation`).
...
* "structured text" tool: <tool name>
...
Note 2: A "structured text" tool is used to identify, attribute and link parts of text files and generate human and machine readable documentation.
