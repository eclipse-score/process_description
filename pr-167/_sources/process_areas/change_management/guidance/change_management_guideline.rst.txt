...
* the affected work products from high level perspective are identified.
* an detailed impact analysis is available. If the change affects safety or security it should be stated explicitly. If safety is affected, the ASIL classification should be added, if applicable.
...
request together with the :need:`[[title]] <rl__contributor>` and takes a decision with the submitting/authoring 
contributor for accepting or rejecting it.
...
.. note::
  ...
  | * The combination of issue status **Open** and any "Process Development Community" status **In Progress** and the Pull Request status **Draft** or **Open** defines the status **in implementation**
...
.. note::
  ...
  | * The combination of issue status **Closed** and any "Process Development Community" status **Done** and the Pull Request status **Merged** defines the status **closed**
